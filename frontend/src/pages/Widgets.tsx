...
@media(max-width:720px){.saeh-prose,.saeh-list li{font-size:14px}
...
@media(min-width:721px){.saeh-tabs{display:flex;flex-wrap:wrap;border:0;border-radius:0;overflow:visible;position:relative}
